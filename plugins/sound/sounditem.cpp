...
//    QIcon::setThemeName("deepin");
    ...
    connect(m_applet, static_cast<void (SoundApplet::*)(DBusSink *) const>(&SoundApplet::defaultSinkChanged), this,
...
void SoundItem::invokeMenuItem(const QString menuId, const bool checked) {
    ...
    if (menuId == MUTE)
        ...
        QProcess::startDetached(
                "dbus-send --print-reply --dest=com.deepin.dde.ControlCenter /com/deepin/dde/ControlCenter com.deepin.dde.ControlCenter.ShowModule \"string:sound\"");
}
